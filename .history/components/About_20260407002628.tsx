          ...
          >
            <div className="relative w-[300px] h-[400px] md:w-[350px] md:h-[450px]">
              ...
              <motion.div
                ...
                className="absolute inset-0 rounded-2xl bg-gradient-to-r from-[#a8dadc]/40 via-white/20 to-[#a8dadc]/40 blur-3xl opacity-20"
              />

              {/* Glass Card */}
              <motion.div
                whileHover={{ scale: 1.02 }}
                className="absolute inset-0 rounded-2xl bg-gradient-to-br from-white/15 to-white/5 backdrop-blur-3xl border border-[#a8dadc]/40 shadow-2xl overflow-hidden p-1 group"
              >
                {/* Animated Border */}
                <motion.div
                  animate={{ rotate: 360 }}
                  transition={{ duration: 20, repeat: Infinity, ease: "linear" }}
                  className="absolute inset-0 rounded-2xl bg-gradient-to-r from-[#a8dadc]/60 via-white/40 to-[#a8dadc]/60 opacity-0 group-hover:opacity-40 transition-opacity duration-300"
                />
