        ...
        <div className="flex justify-between items-center">
          ...
          <Link href="#" className="flex items-center gap-2 group">
            <motion.div
              ...
              className="w-10 h-10 rounded-full bg-gradient-to-r from-[#a8dadc] to-white flex items-center justify-center font-bold text-slate-900 shadow-lg"
            >
              D
            </motion.div>
            <span className="text-xl md:text-2xl font-bold bg-gradient-to-r from-white to-[#a8dadc] bg-clip-text text-transparent group-hover:opacity-80 transition-opacity">
              Dipto
            </span>
          </Link>
